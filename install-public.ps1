...
function Grant-MystPathOwnership {
    ...
    # Never takeown/icacls a system folder â€” only the single leaf file Myst owns.
...
function Repair-MystNvidiaRegistry {
    ...
    # Session-only pointer trail for cursor capture â€” never persist MouseTrails
...
function Repair-MystNvidiaCapture {
    ...
    Write-Step '  NVIDIA hooks reset â€” ShadowPlay recording should work again.' -Color DarkGray
}
...
function Repair-MystWindowsDisplay {
    ...
    Write-Step '  Display hook files cleared â€” Search/Edge UWP hosts should recover after Myst reload.' -Color DarkGray
}
